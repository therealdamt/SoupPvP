...
public abstract class Menu extends ListenerAdapter {
    ...
    protected int menuSize = 54;

    private final Inventory inventory;

    public Menu(Player player) {
        inventory = soup.getServer().createInventory(null, menuSize, menuName);
    ...
    public void onInventoryClickEvent(InventoryClickEvent e) {
        ...
        if (!e.getClickedInventory().getTitle().equalsIgnoreCase(menuName)) return;
